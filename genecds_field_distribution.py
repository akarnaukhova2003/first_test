...
def cds_distr(input_file, output_dir, out_name):
    ...
    product, gene, and note qualifiers in CDS field
    '''
    ...
    with open(input_file) as handle:
            ...
            for feature in rec.features:
                if feature.type == 'CDS':
                    ...
                    if 'note' in feature.qualifiers.keys():
                        cds_note_count += 1
                        rec_flag = 1
                        annot.append(feature.qualifiers['note'][0])
        ...
        out_file.write('CDS with note fields: {}\n'.format(cds_note_count))
        ...
        print('CDS with note fields: {}'.format(cds_note_count))
